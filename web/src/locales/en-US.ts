export default {
  ...
  drama: {
    ...
    styles: {
      custom: 'No style (custom by user)',
      ghibli: 'Ghibli',
      guoman: 'Guoman',
      wasteland: 'Wasteland',
      nostalgia: 'Nostalgia',
  ...
  workflow: {
    ...
    polishArticle: 'Polish Text',
    polishingArticle: 'Polishing...',
    polishSuccess: 'Polish completed, please review and save',
    polishFailed: 'Polish failed',
    polishEmptyWarning: 'Please enter content before polishing',
    ...
    selectFromLibrary: 'Select from Asset Library',
    shotList: 'Shot List',
    ...
    addToLibraryConfirm: 'Are you sure you want to add character "{name}" to the asset library? Once added, it will be managed as an image asset.',
    addedToLibrary: 'Added to asset library!',
  ...
  tooltip: {
    ...
    loadLibraryFailed: 'Failed to load asset library',
    ...
    durationSeconds: 'Duration (seconds)',
    emptyLibrary: 'No character image assets in the asset library yet',
