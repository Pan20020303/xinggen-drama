export default {
  ...
  workflow: {
    ...
    saveChapter: '保存章节',
    polishArticle: '润色文章',
    polishingArticle: '润色中...',
    polishSuccess: '润色完成，请确认后保存',
    polishFailed: '润色失败',
    polishEmptyWarning: '请输入章节内容后再润色',
    ...
    addToLibrary: '添加到素材库',
    addToLibraryConfirm: '确定要将角色“{name}”添加到素材库吗？添加后可作为图片素材统一管理。',
